...
if ($is_editor) {
  ...
  if (isset($thisAnnouncementId) && $thisAnnouncementId && isset($sortDirection) && $sortDirection) {
    ...
    if (isset($_POST['submitAnnouncement'])) {
        ...
        $an_link = urlencode($_SERVER['SERVER_NAME'] .
        ...
        $valid_codes = array(
            "AD", "AE", "AF", "AG", "AI", "AL", "AM", "AL", "AM", "AO", "AQ",
            "AR", "AS", "AT", "AU", "AW", "AX", "AZ", "BA", "BB", "BD", "BE",
            "BF", "BG", "BH", "BI", "BJ", "BL", "BM", "BN", "BO", "BQ", "BR",
            "BS", "BT", "BU", "BV", "BW", "BY", "BZ", "CA", "CC", "CD", "CF",
            "CG", "CH", "CI", "CK", "CL", "CM", "CN", "CO", "CR", "CS", "CT",
            "CU", "CV", "CW", "CX", "CY", "CZ", "DD", "DE", "DJ", "DK", "DM",
            "DO", "DY", "DZ", "EC", "EE", "EG", "EH", "ER", "ES", "ET", "FI",
            "FJ", "FK", "FL", "FM", "FO", "FQ", "FR", "FX", "GA", "GB", "GD",
            "GE", "GF", "GG", "GH", "GI", "GJ", "GL", "GM", "GN", "GP", "GQ",
            "GR", "GS", "GT", "GU", "GW", "GY", "HK", "HM", "HN", "HR", "HT",
            "HU", "HV", "ID", "IE", "IL", "IM", "IN", "IO", "IQ", "IR", "IS",
            "IT", "JE", "JM", "JO", "JP", "JT", "KE", "KG", "KH", "KI", "KM",
            "KN", "KP", "KR", "KW", "KY", "KZ", "LA", "LB", "LC", "LI", "LK",
            "LR", "LS", "LT", "LU", "LV", "LY", "MA", "MC", "MD", "ME", "MF",
            "MG", "MH", "MI", "MK", "ML", "MM", "MN", "MO", "MP", "MQ", "MR",
            "MS", "MT", "MU", "MV", "MW", "MX", "MY", "MZ", "NA", "NC", "NE",
            "NF", "NG", "NH", "NI", "NL", "NO", "NP", "NQ", "NR", "NT", "NU",
            "NZ", "OM", "PA", "PC", "PE", "PF", "PG", "PH", "PK", "PL", "PM",
            "PN", "PR", "PS", "PT", "PU", "PW", "PY", "PZ", "QA", "RH", "RO",
            ...
            "UM", "US", "UY", "UZ", "VA", "VC", "VD", "VE", "VG", "VI", "VN",
            "VU", "WF", "WK", "WS", "YD", "YE", "YT", "YU", "ZA", "ZM", "ZR",
            "ZW"
        );
